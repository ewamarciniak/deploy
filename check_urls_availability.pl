...
my $error_log  = '/home/testuser/project/logs/sitecheck_errors.txt';
# From where program will read WEB Addresses 
my $input_file = '/home/testuser/project/url_adresses.txt';
#In Seconds              
...
my $output_file = '/home/testuser/project/logs/report-'.$date.'.'.$month.'.'.$year.'.txt';
my @all_addr = ();
